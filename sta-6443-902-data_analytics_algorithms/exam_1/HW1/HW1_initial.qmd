...
qqnorm(aug_july_df$Wind[aug_july_df$Month==7]);qqline(aug_july_df$Wind[aug_july_df$Month==7], col = 2)
...
qqnorm(aug_july_df$Wind[aug_july_df$Month==8]);qqline(aug_july_df$Wind[aug_july_df$Month==8], col = 2)
