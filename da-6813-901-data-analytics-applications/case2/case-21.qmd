...
glm_matrix <- confusionMatrix(as.factor(test$Choice),as.factor(glm_class), positive = "1")
glm_accuracy <- glm_matrix$overall[1]
glm_accuracy


radial_matrix <- confusionMatrix(as.factor(test$Choice),as.factor(radial_predictions), positive = "1")
radial_accuracy <- radial_matrix$overall[1]
radial_accuracy

poly_matrix <- confusionMatrix(as.factor(test$Choice),as.factor(poly_predictions), positive = "1")
poly_accuracy <- poly_matrix$overall[1]
poly_accuracy

sigmoid_matrix <- confusionMatrix(as.factor(test$Choice),as.factor(sigmoid_predictions), positive = "1")
sigmoid_accuracy <- sigmoid_matrix$overall[1]
sigmoid_accuracy

linear_matrix <- confusionMatrix(as.factor(test$Choice),as.factor(linear_predictions), positive = "1")
