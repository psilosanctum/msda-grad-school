...
GoogData <- read.csv("/Users/arkaroy1/Downloads/GOOG.csv", header=TRUE, sep=",") 
FBData <- read.csv("/Users/arkaroy1/Downloads/FB.csv", header=TRUE, sep=",") 
SP500Data <- read.csv("/Users/arkaroy1/Downloads/^GSPC.csv", header=TRUE, sep=",") 
